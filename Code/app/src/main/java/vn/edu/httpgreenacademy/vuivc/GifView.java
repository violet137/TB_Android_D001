...
public class GifView extends RelativeLayout {
    ...
    public GifView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.vuivc, 0, 0);
        loop = a.getBoolean(R.styleable.vuivc_loop, false);
        stopSystemAudio = a.getBoolean(R.styleable.vuivc_stopSystemAudio, false);
        muted = a.getBoolean(R.styleable.vuivc_muted, false);
        showSpinner = a.getBoolean(R.styleable.vuivc_showSpinner, true);
        a.recycle();
